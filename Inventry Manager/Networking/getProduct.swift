...
class GetProduct{
    ...
    func getStock(loginObj:login, completionHandler: @escaping (_ error: String?, _ data:[[String:Any]]?) -> ()){
    ...
    private func getStockExt(completionHandler: @escaping (_ error: String?, _ data:[[String:Any]]?) -> ()){
        AF.request(staticLinker.link.getProducts, method: .get, parameters:nil, encoding: JSONEncoding.default, headers: ["Content-Type":"application/json","token":staticLinker.token]).responseJSON(completionHandler: {(response) in
